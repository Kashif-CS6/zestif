    ...
    <div className="mb-10 py-10 rounded-[12px] bg-[#D9D9D9]  flex flex-col items-center justify-center gap-10 px-10">
      <div className="flex items-center justify-between flex-wrap w-full ">
        ...
        <ul className="flex items-center flex-wrap gap-4">
          <li>
            <button className="text-sm font-[400] leading-[100%] py-3 focus:font-[600] focus:rounded-[120px] focus:border-[1px] focus:border-[#FC8A06] focus:text-[#FC8A06] px-2 md:px-4">
              Frequest Questions
            </button>
          </li>
          <li>
